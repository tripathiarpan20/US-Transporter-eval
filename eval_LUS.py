...
parser.add_argument('--vid', type=str, default=None, help='')
parser.add_argument('--frame_no', type=int, default=0, help='')
...
if args.img != None and args.vid != None:
    ...
    plt.savefig(os.path.join('output',args.img))

elif args.vid != None and args.frame_no != None:
    try:
    ...
    pl_forward_LUS(test_input)
    plt.savefig(os.path.join('output','frame'+str(args.frame_no),args.vid)
